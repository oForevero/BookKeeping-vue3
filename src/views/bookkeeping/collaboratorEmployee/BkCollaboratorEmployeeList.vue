...
<script lang="ts" name="org.jeecg.bookkeeping-bkCollaboratorEmployee" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './BkCollaboratorEmployee.api';
